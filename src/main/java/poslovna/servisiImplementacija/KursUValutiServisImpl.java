...
public class KursUValutiServisImpl implements KursUValutiServis {
	...
	public ResponseEntity<List<KursUValuti>> sviKurseviUValutiValute(Long idValute) {
		return new ResponseEntity<List<KursUValuti>>(kursUValutiRepozitorijum.findByOsnovnaValutaOrPremaValuti(valutaRepozitorijum.findOne(idValute), valutaRepozitorijum.findOne(idValute)), HttpStatus.OK);
	}

	@Override
	public ResponseEntity<List<KursUValuti>> sviKurseviUValutiKursneListe(Long idKursneListe) {
		return new ResponseEntity<List<KursUValuti>>(kursUValutiRepozitorijum.findByKursnaLista(kursnaListaRepozitorijum.findOne(idKursneListe)), HttpStatus.OK);
	}
